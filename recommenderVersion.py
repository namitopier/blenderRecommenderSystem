            ...
            if (type(isSame) != bool):
                ...
                if self.tutorialMode:
                    ...
                    if (result == ['correct']):
                        ...
                        if str(self.tut.getProgress() * 100) == "100":
                            update_user_feedback("Correct operation! Your current progress: 99%. Next step:  Perform the following operation: " + str(stepDescription[0]) + " on object '" + str(stepDescription[-2]) + "'")
                        else:
